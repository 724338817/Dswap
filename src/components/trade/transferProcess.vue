<template>
  <el-dialog width="500px" :visible.sync="dialogVisible" :before-close="Close" :close-on-click-modal="false">
    <span class="title">Your transfer is processing…</span>
    <div class="nft_data">
      <img class="" src="../../assets/image/icon_load.png" />
      <div class="nft_info">
        <span>Your transfer of <span class="info_color">{{ transferData.name }}</span> is processing. It should be confirmed on the blockchain shortly.</span>
